    ...
    const [teamTwoData, setTeamTwoData] = useState({
      ...
      const handleCreateTeamTwo = async (event) => {
        ...
        try {
          ...
          const response = await axios.post(
            `http://localhost:5000/api/v1/senior-team/senior-team`,
            newTeamTwoData
          );
        ...
        <div>
              ...
              <form onSubmit={handleCreateTeamTwo}>
                <div className="space-y-4">
                  <h1 className="text-xl">Senior Team Member Name</h1>
                  <input
                    type="text"
                  ...
                  <label className="text-xl">Senior Team Member Designation</label>
                  <input
                    type="text"
                  ...
                  <label className="text-xl">Senior Team Member Bio</label>
                  <textarea
                    className="border border-gray-300 rounded w-full p-2"
...
export default AdminCreateSeniorTeam;